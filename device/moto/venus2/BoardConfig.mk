...
-include vendor/moto/venus2/BoardConfigVendor.mk
...
# Command line
TARGET_PREBUILT_KERNEL := device/moto/venus2/kernel
...
TARGET_PREBUILT_RECOVERY_KERNEL := device/moto/venus2/kernel
BOARD_ALWAYS_INSECURE := true
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_MKE2FS := device/moto/venus2/releaseutils/mke2fs
...
# Graphics
BOARD_EGL_CFG := device/moto/venus2/prebuilt/etc/egl.cfg
...
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := device/moto/venus2/releasetools/venus2_img_from_target_files
